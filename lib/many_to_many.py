...
class Contract:
    ...
    def __init__(self, author, book, date, royalties):
        if not isinstance(author, Author):
            raise Exception("Contract author must be of type Author")
        if not isinstance(book, Book):
            raise Exception("Contract book must be of type Book")
        if not isinstance(date, str):
            raise Exception("Contract date must be a string")
        if not isinstance(royalties, int):
            raise Exception("Contract royalties must be an integer")
